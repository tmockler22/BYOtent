...
class MyTrips extends React.Component {
  ...
  render() {
    ...
    liTrips = Object.values(this.props.bookings).map(booking => <TripIndexItem key={booking.id} campsite={campsites[booking.campsite_id]} booking={booking} currentUser={this.props.currentUser} cancelBooking={this.props.cancelBooking}/>);
